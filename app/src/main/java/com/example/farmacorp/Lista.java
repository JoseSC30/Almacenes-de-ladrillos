...
public class Lista
{      private static  int max=50; //Numero Maximo en la constante MAX
    private Object[] v; //Objeto que voy a insertar en la lista
    private int n;
    ...
    public int dim(){//Devuelve cantidad de vectores.
        return n;
    }
